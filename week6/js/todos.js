...
export default class Tasklist {
    ...
    addTask(content) {
        ...
        this.list.push(task);
        document.querySelector('.list').appendChild(task.createElement(this.save.bind(this), this.removeTask.bind(this)));
        this.save();
    }
    removeTask(task) {
    ...
    updateNumRemaining() {
        ...
        document.querySelector('.task-number').innerHTML = `<p>${numremaining} task${numremaining > 1 ? 's' : ""} remaining</p>`;
    }
}